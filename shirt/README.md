...
The program then overlays shirt.png (which should have a transparent background) on the input after resizing and cropping the input to be the same size, saving the result as its output.  

In case of error the program instead exits via sys.exit:  
